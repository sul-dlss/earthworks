...
describe 'Show page' do
  context 'when gbl_georeferenced_b is not set' do
    it 'have georeference alert' do
      ...
      expect(page).to have_text 'This map is not georeferenced.'
    end
  end
  ...
  context 'when gbl_georeferenced_b is set to true' do
    it 'does not have georeference alert' do
      ...
      expect(page).to have_no_text 'This map is not georeferenced.'
    end
  end
  ...
  context 'when page is a non iiif page' do
    it 'does not have georeference alert' do
      ...
      expect(page).to have_text 'tectonic map of Britain, Ireland and adjacent areas'
      expect(page).to have_no_text 'This map is not georeferenced.'
    end
  end
end
